...
main() {
    ...
    # Support setup removes a legacy root-execution path and installs the
    # unprivileged queue worker. A failure here is a security/readiness failure,
    # not an optional feature warning.
